...
export default function IndicatorFrame(props: ViewProps) {
  const {indicatorFrame, setIndicatorFrame, containerRef} = useContext(Context);
  const [myFrame, setMyFrame] = useState<LayoutRectangle>();
