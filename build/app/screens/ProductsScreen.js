...
export default createScreen('Products', ({ groupId }) => {
    ...
    return (<Scaffold.FlatList topNav={<TopNavigation title={groupId}/>} data={data} renderItem={({ item }) => (<TouchableHighlight style={styles.item} underlayColor={styles.underlay.backgroundColor} onPress={() => navigate('ProductDetails', { id: item.id })}>
